  ...
  return (
    <header className="bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pb-2 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-700 tracking-tight">
            LA PAZ <span className="text-brand-orange">QR</span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl font-semibold text-slate-600">
            GUÍA DE CIUDAD
          </p>
          <p className="text-lg sm:text-xl md:text-2xl font-semibold text-slate-600">
            CITY GUIDE
