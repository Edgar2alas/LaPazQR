const JIWAKI_URL = 'https://lapaz.bo/agendajiwaki/teatros/' // TODO: reemplazar por el link real
    ...
    <section className="bg-gradient-to-r from-brand-orange to-orange-500 py-14 px-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="text-white text-center md:text-left">
          <p className="text-2xl sm:text-3xl md:text-4xl font-light">Jiwaki</p>
          <p className="text-3xl sm:text-4xl md:text-5xl font-bold italic -mt-1">
            agenda
          </p>
          <p className="mt-3 text-sm sm:text-base uppercase tracking-wide text-white/90">
            La agenda cultural andina y boliviana
          </p>
        </div>
        ...
        >
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-12 h-12 md:w-14 md:h-14 text-white group-hover:scale-110 transition-transform"
          >
